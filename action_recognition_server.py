...
import tornado.log
import platform
from controllers.AlgorithmHandler import AlgorithmHandler,IndexHandler

def Start(ip, port, debug=True):
    print("action_recognition_server http://%s:%d start" % (ip, port))
    ...
    conf = dict(
        ...
        xsrf_cookies=False,
        cookie_secret="action_recognition_server",
...
if __name__ == "__main__":
    ...
    Start(ip="0.0.0.0", port=9701, debug=True)